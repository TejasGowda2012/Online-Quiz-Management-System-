...
$setNumber = rand(1, 3); // Select random set from 1 to 3 for JavaScript
...
$sql = "SELECT * FROM mcqs WHERE category = 'JavaScript' AND id BETWEEN " . $range[0] . " AND " . $range[1];
...
<html>
<head>
    <title>JavaScript Quiz (Set <?php echo $setNumber; ?>)</title>
...
<body  style="background-image: url('https://t4.ftcdn.net/jpg/06/91/05/19/360_F_691051962_GFhQPOAXABmf7l706q89b2PFh6FnB1kI.jpg'); background-size: cover; background-repeat: no-repeat;">
    <h1>JavaScript Quiz (Set <?php echo $setNumber; ?>)</h1>
    <form id="quizForm" method="post" action="process_js_quiz.php">
    ...
    <div id="timer"><i class="fas fa-clock"></i><span id="time">5:00</span></div>
    <script>
