...
$setNumber = rand(1, 3); // Select random set from 1 to 3 for PHP
...
$sql = "SELECT * FROM mcqs WHERE category = 'PHP' AND id BETWEEN " . $range[0] . " AND " . $range[1];
...
<html>
<head>
    <title>PHP Quiz (Set <?php echo $setNumber; ?>)</title>
...
<body  style="background-image: url('https://t4.ftcdn.net/jpg/06/91/05/19/360_F_691051962_GFhQPOAXABmf7l706q89b2PFh6FnB1kI.jpg'); background-size: cover; background-repeat: no-repeat;">
    <h1>PHP Quiz (Set <?php echo $setNumber; ?>)</h1>
    <form id="quizForm" method="post" action="process_php_quiz.php">
