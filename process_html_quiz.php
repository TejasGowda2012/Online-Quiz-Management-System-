...
$subject = 'HTML'; // Since it's htmlquiz.php
$user_id = 0;
...
// Calculate marks
$marks = 0;
$sql = "SELECT * FROM mcqs WHERE category = 'HTML' AND id BETWEEN " . (($setNumber - 1) * 5 + 1) . " AND " . ($setNumber * 5);
...
try {
    ...
    $mail->Body = "
        <h2>Quiz Results</h2>
        <p>Dear $username,</p>
        <p>Thank you for taking the HTML quiz. Here are your results:</p>
        <ul>
