...
// Calculate marks
$marks = 0;
$sql = "SELECT * FROM mcqs WHERE category = 'PHP' AND id BETWEEN " . (($setNumber - 1) * 5 + 56) . " AND " . ($setNumber * 5 + 55); // Adjusted IDs for PHP
...
try {
    ...
    $mail->Body = "
        <h2>Quiz Results</h2>
        <p>Dear $username,</p>
        <p>Thank you for taking the PHP quiz. Here are your results:</p>
        <ul>
